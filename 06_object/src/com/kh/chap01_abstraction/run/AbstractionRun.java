...
public class AbstractionRun {
	 ...
	 *  	1)"변수"만으로 프로그래밍을 한다면?
	 *  
	 *  	  * 변수 - 하나의 자료형에 하나의 값만을 보관할 수 있다.
	 *  	만약 홍길동이라는 학생 객체를 만들어내기 위해서? --> String name1 ="홍길동"; int age1 = 20; double height1 = 162.3;
	 *  	만약 김말똥이라는 학생 객체를 만들어내기 위해서? --> String name2 ="김말똥"; int age2 = 21; double height2 = 173.4;
	 *  	만약 강개순이라는 학생 객체를 만들어내기 위해서? --> String name3 ="홍길동"; int age3 = 22; double height3 = 182.7;
	 ...
	 *  
	 *  	어떤문제가 발생? => 기존의 학생정보를 지워야할때 정보들을 앞으로 당겨줘야한다. 근데 혹시라도 실수한다면? 학생들의 정보다 뒤바뀔 수 있음
	 *  					새로운 학생정보를 기록해야할 때 배열의 크기는 변경할 수 없기때문에 새로운 크기의 배열을 만들어서 기존껄 복사한다거나 
	 *  					이런식으로 과정이 복잡하다
	 *  
	 *  
	 *  	3) 그래서 나온 개념은 '구조체'
	 ...
	 *  
	 *  	String 값도 보관하고,int값도 보관하고 ,double값도 같이 보관할 수 있도록 나만의 배열같은 자료형을 만들자 !  그게바로 클래스!! 
	 *  	Student라는 클래스로 만들꺼임! =>객체의 정보를 보관할 그릇과도 같은 클래스들은 => model.vo
	 *  	
	 *  
	 *  
	 *  
	...
	public static void main(String[] args) {
		...
		// 자바에서 객체로 만들기 위해서 new라는 키워드를 통해서 Heap영역에 생성 먼저 해야됨 ! 
		...
		System.out.println(hong); //이상함	
		System.out.println(hong.name+"님의 나이는"+hong.age+"살 이고, 키는"+hong.height+"cm 입니다.");
		// 직접 접근을 통해 값을 가져왔음
		...
		//출력
		System.out.println(ddong.name+"님의 나이는"+ddong.age+"살 이고, 키는"+ddong.height+"cm 입니다.");
