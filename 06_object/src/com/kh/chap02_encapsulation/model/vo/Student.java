...
public class Student {
		 ...
		 * * 메소드 
		 * <표현법>
		 * 접근제한자[예약어} 반환형(int,double...etc) 메소드명([매개변수]){
		 * 			//기능 구현
		 * 
		 * }
		 * 
		...
		//- setter 메소드 
		//	해당 필드에 대입시키고자하는 값 전달받아 해당 필드에 대입시켜주는 기능의 메소드
...
*/ 
		public void setName(String name) {
			...
			// (왜? 필드명과 매개변수명이 동일한 시점에서{}내의 해당 변수명 지세세 해당 영역에서 만들어진 변수가 우선순위가 높음)
			
			//필드의 name = 매개변수 name; 원함
